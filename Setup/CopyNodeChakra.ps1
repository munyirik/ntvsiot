...
switch($arch) {
    "arm" { $nodeExeUrl = [uri]"https://github.com/ms-iot/ntvsiot/releases/download/5.0.0-exe-arm/node.exe" }
    "x86" { $nodeExeUrl = [uri]"https://github.com/ms-iot/ntvsiot/releases/download/5.0.0-exe-x86/node.exe" }
    "x64" { $nodeExeUrl = [uri]"https://github.com/ms-iot/ntvsiot/releases/download/5.0.0-exe-x64/node.exe" }
