...
.Description
    ...
    Extension based on the code in this branch.
    
    The assembly and file versions are generated automatically and provided by
    modifying ..\Product\AssemblyVersion.cs.
...
$build_project = gi "$buildroot\Setup\dirs.proj"
