...
{ 
    public class NodejsUapPropertyStore : IDisposable, IPropertyStore
    {
        private bool disposed = false;

        private List<NodejsUapProjectFlavorCfg> configs =
            new List<NodejsUapProjectFlavorCfg>();
        ...
        public void Initialize(object[] dataObjects)
        {
            ...
            foreach (object dataObject in dataObjects)
            {
                if (dataObject is IVsCfg)
                {
                    ...
                    NodejsUapProjectFlavorCfg config = NodejsUapProjectFlavorCfg
        ...
        public void Persist(string propertyName, string propertyValue)
        {
            ...
            foreach (NodejsUapProjectFlavorCfg config in configs)
            {
                // Set the property
