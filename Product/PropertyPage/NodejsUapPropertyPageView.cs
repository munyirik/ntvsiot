...
{
    [Guid(GuidList.NodejsUapPropertyPageViewString)]
    partial class NodejsUapPropertyPageView : PageView
    {
        #region Constructors
        /// <summary>
        ...
        public NodejsUapPropertyPageView(IPageViewSite site)
            : base(site)
        {
            InitializeComponent();
        }
        ...
        /// </summary>
        public NodejsUapPropertyPageView()
        {
            InitializeComponent();
        }
        #endregion
		...
		protected override PropertyControlTable PropertyControlTable
        {
            get
            {
                if (propertyControlTable == null)
                {
                    ...
                    propertyControlTable.Add(NodejsUapConstants.DebuggerMachineName, _debuggerMachineName);
                    propertyControlTable.Add(NodejsUapConstants.NodeExeArguments, _nodeArguments);
                    propertyControlTable.Add(NodejsUapConstants.ScriptArguments, _scriptArguments);
                }
