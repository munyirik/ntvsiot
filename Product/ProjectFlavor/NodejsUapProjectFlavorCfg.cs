...
{
    class NodejsUapProjectFlavorCfg :
        IVsCfg,
        IVsProjectCfg,
        IVsProjectCfg2,
        IVsProjectFlavorCfg,
        ...
        IPersistXMLFragment
    {
        ...
        static Dictionary<IVsCfg, NodejsUapProjectFlavorCfg> mapIVsCfgToNodejsUapProjectFlavorCfg = new Dictionary<IVsCfg, NodejsUapProjectFlavorCfg>();
        ...
        #endregion
        public NodejsUapProjectFlavorCfg(NodejsUapProjectFlavor baseProjectNode, IVsCfg baseConfiguration, IVsProjectFlavorCfg innerConfiguration)
        {
            _baseCfg = baseConfiguration;
            _innerCfg = innerConfiguration;
            project = baseProjectNode;
            mapIVsCfgToNodejsUapProjectFlavorCfg.Add(baseConfiguration, this);
        }
        ...
        public int Close()
        {
            mapIVsCfgToNodejsUapProjectFlavorCfg.Remove(_baseCfg);
        ...
        int IVsQueryDebuggableProjectCfg.QueryDebugTargets(uint grfLaunch, uint cTargets, VsDebugTargetInfo2[] rgDebugTargetInfo, uint[] pcActual)
        {
            ...
            if (rgDebugTargetInfo != null && rgDebugTargetInfo.Length > 0)
            {
                ...
                propertiesList.TryGetValue(NodejsUapConstants.DebuggerMachineName, out debuggerMachineName);
        ...
        private bool IsMyFlavorGuid(ref Guid guidFlavor)
        {
            return guidFlavor.Equals(
                GuidList.guidNodejsUapProjectFactory);
        }
        ...
        private void PrepareNodeStartupInfo()
        {
            ...
            propertiesList.TryGetValue(NodejsUapConstants.NodeExeArguments, out nodeExeArguments);
            string scriptArguments;
            propertiesList.TryGetValue(NodejsUapConstants.ScriptArguments, out scriptArguments);
        ...
        internal static NodejsUapProjectFlavorCfg GetPropertyPageFromIVsCfg(IVsCfg configuration)
        {
            if (mapIVsCfgToNodejsUapProjectFlavorCfg.ContainsKey(configuration))
            {
                return (NodejsUapProjectFlavorCfg)mapIVsCfgToNodejsUapProjectFlavorCfg[configuration];
            }
            else
            {
