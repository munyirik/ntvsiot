...
{
    [Guid(GuidList.NodejsUapProjectFlavorString)]
    class NodejsUapProjectFlavor : 
        FlavoredProjectBase,
        IVsProjectFlavorCfgProvider
    {
        internal NodejsUapPackage _package;
        ...
        public int CreateProjectFlavorCfg(IVsCfg pBaseProjectCfg, out IVsProjectFlavorCfg ppFlavorCfg)
        {
            ...
            ppFlavorCfg = new NodejsUapProjectFlavorCfg(this, pBaseProjectCfg, cfg);
                ...
                case __VSHPROPID2.VSHPROPID_CfgPropertyPagesCLSIDList:
                    {
                        ...
                        property += ';' + typeof(NodejsUapPropertyPage).GUID.ToString("B");
